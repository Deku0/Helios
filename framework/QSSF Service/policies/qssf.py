...
class QuasiShortestServiceFirst(Policy):
    ...
    def simulate(self):
        ...
        #jobname                          vc     user state     submit_time         start_time        end_time          gpu_num gpu_alloc nodelist   duration  queue
        #application_1506638472019_2050,6214e9,ef4fdc,Killed,2017-10-01 00:00:27,2017-10-01 00:00:43,2017-10-01 03:39:41,   1    [1]      ['m88']         13138    16
